  ...
  <div className="flex flex-col justify-between h-full p-4">
    ...
    <div className="mt-4 w-full flex space-x-2">
      <a
        ...
        className="flex-1 text-white items-center bg-green-500 hover:bg-green-600 hover:shadow-lg p-2 rounded-lg hover:shadow-green-500/50 transition-all duration-300"
      >
        View on Hey
      </a>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex-1 items-center text-white bg-green-500 hover:bg-green-600 hover:shadow-lg p-2 rounded-lg hover:shadow-green-500/50 transition-all duration-300"
      >
        View on Orb
      </a>
    </div>
